        ...
        <div className={css.groupContainer}>
            ...
            <div className={css.groupDataContainer}>
                <div className={css.groupInfoContainer}>
                    <p className={css.groupDataText} style={{ marginBottom: 15}}> <strong style={{fontSize: 18}}>Опис:</strong> ця група створена для користувачів, які хочуть першими дізнаватися найцікавішу інформацію про українські фільми  </p>
                    <p className={css.groupDataText} style={{ marginBottom: 22}}> <strong style={{fontSize: 18}}>Правила:</strong> заборонена неетична поведінка, шкідливе програмне забезпечення,  порушення конфіденційності, спам і фальшиві облікові записи, а також способи обходу цих заборон.</p>
                    <ul className={css.groupTagsContainer}>
                        <li className={css.groupTag}>
                            #Українською
                        </li>
                        <li className={css.groupTag}>
                            #Фільми
            ...
            <GroupPost img="" title="Завтра виходить новий УКРАЇНСЬКИЙ фільм “Гонки. Моя остання місія”. Хтось вже має трейлер щоб глянути?"/>

...
const NavPanel = () => {
    ...
    return ( 
        ...
        <div className="mt-4 xl:ml-16 p-3 bg-MainColor cursor-pointer  rounded-[21px] w-fit flex flex-row xl:flex-col gap-3  mb-[10px] md:mb-6">
            <Link href="/topics" className="p-2 hover:bg-AccnetColor bg-[#262D34] flex gap-2 items-center rounded-[10px] h-[60px] w-90 lg:w-90">
                <div className="w-9 h-9 bg-SecondaryColor rounded-[20px] flex items-center justify-center">
            ...
            <div className="p-2 bg-[#262D34] flex gap-2 hover:bg-AccnetColor items-center rounded-[10px] h-[60px] w-90 lg:w-90">
                <div className="w-9 h-9 bg-SecondaryColor rounded-[20px] flex items-center justify-center">
                    <svg className="w-6 h-6" >
            ...
            <div className="p-2 bg-[#262D34] hover:bg-AccnetColor flex gap-2 items-center rounded-[10px] h-[60px] w-90 lg:w-90">
                <div className="w-9 h-9 bg-SecondaryColor rounded-[20px] flex items-center justify-center">
                    <svg className="w-6 h-6" >
        ...
        <div>
            <div className="hidden xl:ml-16 xl:w-[272px] xl:p-6 xl:bg-MainColor xl:rounded-[21px]  xl:flex xl:flex-col xl:gap-3 xl:mb-6">
                ...
                <div className="flex gap-2 hover:bg-AccnetColor p-[10px] rounded-[10px] items-center">
            ...
            <div>
                <div
                    className="hidden xl:ml-16 xl:w-[272px] xl:p-6 xl:bg-MainColor rounded-[21px] xl:flex xl:flex-col xl:gap-3 xl:mb-6">
                ...
                <div className="flex gap-[15px] cursor-pointer hover:bg-AccnetColor p-[10px] rounded-[10px] items-center">

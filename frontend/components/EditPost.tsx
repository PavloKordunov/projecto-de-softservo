        ...
        <div className="w-full h-full absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
            <div className="bg-MainColor px-10 py-6 rounded-[31px] w-fit">
                <div className="flex justify-between items-center mb-8">
                    <p className="text-[36px] text-white font-semibold">Редагувати пост</p>
                ...
                <div className="flex gap-16 justify-between items-center mb-6">
                    <p className="text-[18px] text-white font-semibold">Заголовок:</p>
                    <input
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <textarea
                        ...
                        className="w-[450px] h-28 px-4 py-2 resize-none text-white bg-SecondaryColor border-none rounded-[10px] focus:outline-none"
                        placeholder="Введіть опис..."
                    ></textarea>
                </div>
                <div className="flex gap-12 items-center mb-6">
                    <p className="text-[18px] text-white font-semibold">Зображення:</p>
                ...
                <div className="w-full flex justify-end">
                    <button
                        ...
                        className="px-4 py-2 bg-AccnetColor rounded-[10px] items-center justify-center text-white text-[16px] h-[50px] font-medium"
                    >
                        Оновити пост
                    </button>
                </div>

                ...
                <div className="flex gap-3 items-center mr-28">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-6 items-center">
                            <p className="text-white text-[48px] font-semibold leading-[48px] m-0">Name</p>
                            <svg className="w-9 h-8" fill="#fff">
                                <use href={`/sprite.svg#changeProfileIcon`} />
                            </svg>
                        </div>
                        <p className="text-[#97989D] text-[24px] font-semibold leading-[24px] m-0">@Nickname</p>
                    </div>
                </div>
                <div className="flex items-center gap-24">
                    <div className="flex flex-col items-center">
                        <p className="text-white text-[26px] font-semibold leading-[26px] m-0">1200</p>
                        <p className="text-white text-[26px] font-semibold leading-[26px] m-0">Читачі</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <p className="text-white text-[26px] font-semibold leading-[26px] m-0">700</p>

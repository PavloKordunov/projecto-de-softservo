    ...
    return (
        <div>
            ...
            <div className="p-4 mt-7 bg-MainColor rounded-[21px] mb-6 w-[1030px]">
                <input type="text"
                       className=" w-[580px] h-14 py-2 text-white bg-MainColor border-none rounded-[10px] focus:outline-none"
                       placeholder="Поширте те, що коїться у вас в голові..."
                       onChange={(e) => setCommentData((prev: any) => {
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex gap-4">
                        <button className="px-3 py-2 bg-AccnetColor rounded-[17px] text-white text-[16px] font-bold"
                                onClick={createComment}>Коментувати
                        </button>
                    </div>
                </div>
            </div>
